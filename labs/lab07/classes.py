...
class Card:
    ...
    def power(self, other_card):
        ...
        """
        "*** YOUR CODE HERE ***"
        card_power = self.attack - other_card.defense / 2
        return card_power
...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        swap_attack = other_card.defense
        swap_defense = other_card.attack
        other_card.attack = swap_attack
        other_card.defense = swap_defense
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        opponents_cards = opponent.deck.cards[:]
        ...
        for card in opponents_cards:
            if other_card.attack == card.attack and other_card.defense == card.defense:
