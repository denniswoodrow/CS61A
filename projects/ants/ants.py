...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if isinstance(place.ant, ContainerAnt) and isinstance(self, ContainerAnt) == False and place.ant.contained_ant == None:
                place.ant.contain_ant(self)
            elif isinstance(self, ContainerAnt) and isinstance(place.ant, ContainerAnt) == False and self.contained_ant == None:
                self.contain_ant(place.ant)
                place.ant = self
            elif (isinstance(place.ant, ContainerAnt) and isinstance(self, ContainerAnt)) or (place.ant.contained_ant is not None or self.contained_ant is not None):
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        """Eats a random Bee in the HungryAnt's place. 
        Reduces Bee's armor to 0. Restarts the digesting timer.
        """
    ...
    def action(self, gamestate):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        """Checks to see if the HungryAnt is digesting.
        Decrements the digesting counter.
        """
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        if self.true_Queen == False:
            ...
            while current_place.exit != None:
                ...
                if current_place.ant != None and current_place.ant.double_dmg == False:
                    current_place.ant.double_dmg = True
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if self.true_Queen == True and self.armor - amount <= 0:
            Ant.reduce_armor(self, amount)
            bees_win()
        # END Problem EC
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem Optional 2
        "*** YOUR CODE HERE ***"
        """Takes in other ant as an argument. 
        Returns True if this ant doesn't already contain an ant,
        and the other ant isn't a ContainerAnt.
        """
    ...
    def contain_ant(self, ant):
        # BEGIN Problem Optional 2
        "*** YOUR CODE HERE ***"
        # Sets the bodyguard's contained_ant instance attribute to the passed in ant argument.
    ...
    def action(self, gamestate):
        # BEGIN Optional 2
        "*** YOUR CODE HERE ***"
        # Perform the contained_ant's action if the ContainerAnt is currently containing an ant.
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem Optional 4
        "*** YOUR CODE HERE ***"
        if target and target.scared_once is False:
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, beehive):
        # BEGIN Problem Optional 5
        insect_targets, current_place, distance = {}, self.place, 0
        while current_place is not beehive:
            if current_place.ant is not None and isinstance(current_place.ant, LaserAnt) is False:
                insect_targets.update({current_place.ant: distance})
            if current_place.bees is not []:
                for bee in current_place.bees:
                    insect_targets.update({bee: distance})
            current_place = current_place.entrance
            distance += 1
        return insect_targets
        # END Problem Optional 5

    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        old_dmg, distance_reduction, insects_reduction = self.damage, distance * .2, self.insects_shot * .05
        new_dmg = old_dmg - distance_reduction - insects_reduction
        return new_dmg
        # END Problem Optional 5
