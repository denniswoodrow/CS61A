...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    counter, total, pig_out = 0, 0, False
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    potential_gcd, final_gcd = 1, 0
    while potential_gcd <= opponent_score:
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    num_rolls, max_avg_score, dice_num_max_avg = 1, 0, 0
    while num_rolls < 11:
        avg_dice = make_averaged(roll_dice, trials_count)
        find_max_avg_score = avg_dice(num_rolls, dice)
        if find_max_avg_score > max_avg_score:
            max_avg_score = find_max_avg_score
            dice_num_max_avg = num_rolls
        num_rolls += 1
    return dice_num_max_avg
    # END PROBLEM 9
